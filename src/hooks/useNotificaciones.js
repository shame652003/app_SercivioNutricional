...
        if (action === 'nueva') {
            // ⭐ ESTE ES EL CÓDIGO CLAVE PARA AÑADIR LA NOTIFICACIÓN
...
    }, [setNotificaciones]); // ⭐ AÑADIDA DEPENDENCIA setNotificaciones
...
                // El payload del socket (data) se pasa como notificacionData
                handleSocketUpdate({ action: 'nueva', notificacionData: data });
            });
            
            // Listener para actualizaciones (marcar/eliminar)
...
    // ... (resto de las funciones manipularNotificacion, etc., se mantienen igual)
